...
main(int argc, char *argv[])
{
  ...
  n = close(fd);
  if (n == -1) {
    printf(1, "sdfasdafwritdfasdasfdasfe system call successfully accepted an overflowing pointer in a shared page\n");
    test_failed();
  }
